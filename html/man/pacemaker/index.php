...
?>
	 ...
	 <dd>
	   <p>The <strong class="command">crm_mon</strong> command
	 ...
	 <dd>
	   <p>The <strong class="command">cibadmin</strong> command is
	 ...
	 <dd>
	   <p>The <strong class="command">crm_diff</strong> command
	 ...
	 <dd>
	   <p>The <strong class="command">crm_attribute</strong>
	 ...
	 <dd>
	   <p>The <strong class="command">crm_verify</strong> command
	 ...
	 <dd>
	   <p>The <strong class="command">crm_resource</strong>
	 ...
	 <dd>
	   <p>The <strong class="command">crm_failcount</strong>
	 ...
	 <dd>
	   <p>UUIDs are used to identify cluster nodes to ensure that
	     they can always be uniquely identified. The command
	       <strong class="command">crm_uuid</strong> displays the
	     ...
	     to a known value.  This can also be achieved with
	       <strong class="command">crm_uuid</strong> , but you
	 ...
	 <dd>
	   <p>The <strong class="command">crm_standby</strong> command
