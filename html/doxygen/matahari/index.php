...
<body>
  ...
  <div id="inner-body" style="text-align: left;">
	...
	<h2>Autogenerated Matahari Documentation</h2>
        <?php
...
foreach ($runs as $hash) {
    ...
    echo " [<a href=$hash/group__coreapi.html>Core APIs</a>]";
    echo " [<a href=https://github.com/matahari/matahari/commit/$hash>Git</a>]";
    echo "</li>";
    $lpc++;
}
